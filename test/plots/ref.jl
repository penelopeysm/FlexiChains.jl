...
const REFTEST_SPECS = [
    ...
    RefTestSpec(MakieBE(), "mridgeline", () -> FC.mridgeline(chn)),
    RefTestSpec(MakieBE(), "mforestplot", () -> FC.mforestplot(chn)),
    RefTestSpec(MakieBE(), "mforestplot_options", () -> FC.mforestplot(chn; point = :mean, interval = :hdi, hdi_method = :multimodal, levels = (0.5, 0.95))),
