...
$(FC._PARAM_DOCSTRING("FlexiChains.mridgeline"))
...
function FC.mridgeline!(chn::FC.FlexiChain, param_or_params; kwargs...)
    return FC.mridgeline!(Makie.current_axis(), chn, param_or_params; kwargs...)
end
